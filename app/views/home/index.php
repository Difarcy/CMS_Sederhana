...
<body class="landing-page">
    <header class="main-header">
        <nav class="main-nav">
            <a href="/CMS_Sederhana/public/" class="brand-logo">
            ...
            <div class="nav-right-links">
                <a href="/CMS_Sederhana/login" class="nav-login">Log In</a>
                <a href="/CMS_Sederhana/login" class="nav-cta">Get Started</a>
            </div>
        </nav>
    </header>
    ...
    <main class="hero-section">
        <div class="hero-content">
            <div class="hero-text">
                ...
                <a href="/CMS_Sederhana/login" class="hero-cta">Get Started</a>
            </div>
